  ...
  return (
    <main className="min-h-screen lg:grid lg:grid-cols-[1.05fr_0.95fr]">
      <aside className="relative hidden overflow-hidden bg-primary px-10 py-10 text-primary-foreground lg:flex lg:flex-col xl:px-16 xl:py-12">
        <div className="pointer-events-none absolute -left-32 top-1/3 h-96 w-96 rounded-full bg-brand/18 blur-3xl" />
        <div className="pointer-events-none absolute -right-24 -top-24 h-80 w-80 rounded-full bg-amber-200/8 blur-3xl" />
        ...
        <div className="relative my-auto max-w-lg py-16">
          <p className="text-sm font-medium text-brand">Your job search, organized</p>
            ...
            {highlights.map((highlight) => {
              ...
              return (
                <div key={highlight.text} className="flex items-center gap-4">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-white/6 text-brand">
